/* usart.c — 921600 baud para transmisión de audio */
#include "usart.h"
...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Init.BaudRate = 921600;   /* subido de 115200 para transmisión de audio */
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if (uartHandle->Instance == USART1)
  {
    ...
    GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;   /* HIGH para 921600 */
