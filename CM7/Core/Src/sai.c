...
void MX_SAI2_Init(void)
{
  ...
  if (HAL_SAI_InitProtocol(&hsai_BlockA2, SAI_I2S_STANDARD, SAI_PROTOCOL_DATASIZE_24BIT, 2U) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  if (HAL_SAI_InitProtocol(&hsai_BlockB2, SAI_I2S_STANDARD, SAI_PROTOCOL_DATASIZE_24BIT, 2U) != HAL_OK)
  {
    Error_Handler();
  }
