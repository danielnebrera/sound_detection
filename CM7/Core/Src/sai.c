...
/**
  ...
  *
  * v2.1.7 - E0 CONTROL PROFILE
  * SCK/WS/SD GPIO speed remains GPIO_SPEED_FREQ_VERY_HIGH.
  ******************************************************************************
  */
...
static uint32_t SAI2_client = 0U;
...
void HAL_SAI_MspInit(SAI_HandleTypeDef* saiHandle)
{
  ...
  if (saiHandle->Instance == SAI2_Block_A)
  {
    ...
    /**
      ...
      * PI7     ------> SAI2_FS_A
      *
      * E0 control: original v2.1.7 electrical setting.
      */
